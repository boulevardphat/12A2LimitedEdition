...
function checkPassword() {
    ...
    if (pwdValue === data.password) {
        ...
        setTimeout(() => {
            ...
            }, 600); // Giảm thời gian chờ để thư mở ra ngay
        }, 300);
    } else {
